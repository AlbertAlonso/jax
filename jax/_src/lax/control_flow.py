...
def scan(f: Callable[[Carry, X], Tuple[Carry, Y]],
  ...
  Args:
    ...
    unroll: optional positive int specifying, in the underlying operation of the
      ...
      iteration of a loop.
    axis: optional non-negative int specifying the axis on which the scan should
      occur
...
def _scan_typecheck(bind_time, *avals, reverse, length, num_consts, num_carry,
  ...
  x_avals_mapped = _map(partial(core.mapped_aval, length, axis), x_avals)
  core.typecheck_assert(
